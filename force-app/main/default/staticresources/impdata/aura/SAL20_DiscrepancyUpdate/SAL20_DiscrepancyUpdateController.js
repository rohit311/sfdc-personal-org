    ...
    onAddSaveDiscrepancy : function(component, event, helper) {
        ...
        action.setCallback(this, function( res){
            ...
            if ( 'FAILURE' !=res.getReturnValue() ){ 
                ...
                console.log(response);
                component.set("v.attributeWrapperObj" , response);
                helper.showToast(component,'Success!', 'Discrepany records saved successfully!', 'success');
            }else{
                console.log(res.getReturnValue());
                helper.showToast(component,'Error!', 'Something went wrong...', 'error');
            }*/
        });
        $A.enqueueAction(action);
    },
    ...
    onSendEmailPending : function(component, event, helper) {
        ...
        action.setCallback(this, function( res){
            ...
            if ( 'FAILURE' !=res.getReturnValue() ){ 
                ...
                console.log(response);
                component.set("v.attributeWrapperObj" , response);
                helper.showToast(component,'Success!', 'Communication completed successfully!', 'success');
            }else{
                console.log(res.getReturnValue());
                helper.showToast(component,'Error!', 'Something went wrong...', 'error');
            }*/
