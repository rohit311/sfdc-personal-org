...
function ExpandAll(){
while (document.getElementsByClassName(' collapsibleListClosed')!=null && document.getElementsByClassName(' collapsibleListClosed').length>0)
{
	var elem = document.getElementsByClassName(' collapsibleListClosed');
...
function collaspseAll(){
while (document.getElementsByClassName(' collapsibleListOpen')!=null && document.getElementsByClassName(' collapsibleListOpen').length>0)
{
	var elem = document.getElementsByClassName(' collapsibleListOpen');
		for(i =0;i<elem.length;i++)
			{
			elem[i].click();
			}
